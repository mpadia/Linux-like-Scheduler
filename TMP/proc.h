...
struct	pentry	{
	...
	int	pprio;			/* process priority		*/
        int 	counter; 		/* to keep track of quantum left*/
	int 	ocounter;		/* to ensure that quantum dont reach too high value, causing starvation */
	int 	nprio;			/* prio change during epoch 	*/
	int 	chgprio;		/* to know prio chnged in epoch	*/
	int 	ncreate;		/* to tack new proc in epoch	*/
	int 	realproc;		/* keep tracks of real process	*/
